...
const Button = ({ text, icon, type, scrollTo }) => {
  ...
  return (
    ...
    <button onClick={handleClick} type={type}  className=" bg-black-200 flex  px-4 py-4 rounded-lg justify-center items-center overflow-hidden group relative z-20 cursor-pointer mt-5 md:h-16  h-12 md:w-80 w-60">
